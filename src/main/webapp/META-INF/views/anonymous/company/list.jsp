...
<acme:list>
	...
	<acme:list-column code="anonymous.company.list.label.phone" path="phone" width="25%" />
	<acme:list-column code="anonymous.company.list.label.email" path="email" width="25%" />
</acme:list>
