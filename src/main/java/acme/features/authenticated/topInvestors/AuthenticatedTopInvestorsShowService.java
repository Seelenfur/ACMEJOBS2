...
@Service
public class AuthenticatedTopInvestorsShowService implements AbstractShowService<Authenticated, Investor> {

	@Autowired
	private AuthenticatedTopInvestorsRepository repository;
